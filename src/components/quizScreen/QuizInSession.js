...
const QuizInSession = ({ user, quiz, setScreen}) => {
  ...
  const goNextQ = () => {
    ...
    newRecord.push({
      answer: answer,
      correct: answer === content[currentQuestion].answer
    });
    setRecord(newRecord);
  ...
  const getScore = (rec) => {
    ...
    for (let i = 0; i < count; i++) {
      if (rec[i].correct) correct = correct + 1;
    }
  ...
  return (
    <>
      ...
      />
      <div
        className="container-fluid text-white workspace-container p-5 pt-2 flex-grow-1"
        ...
        <div className="container-fluid">
          ...
          <div className="row py-5 justify-content-center">
            <div className="col-lg-6 col justify-content-center">
              {currentQuestion >= 0 && currentQuestion < count && (
                <Question
            ...
            <div className="col-auto align-self-center">
              {currentQuestion !== count && (
                <button
                  ...
                  onClick={() => goNextQ()}
                >
                  {currentQuestion === count - 1 ? "Finish" : "Next Question"}
                </button>
              )}
            </div>
